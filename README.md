...
1. Clone the repo
   ```sh
   git clone https://github.com/awell00/acoustic_communication.git
   ```
...
[sender-screenshot]: https://images.salmero.fr/images/sender.png
[receiver-screenshot]: https://images.salmero.fr/images/receiver.png
